...
const Translator: React.FC<TranslatorProps> = ({ entries, onNavigate }) => {
  ...
  return (
    <div className="flex-grow flex flex-col bg-white rounded-lg shadow-lg border border-slate-200 p-4 sm:p-6 md:p-8 animate-fade-in min-h-0 overflow-hidden">
      ...
      <div className="flex-shrink-0 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-slate-200 text-sm font-medium rounded-md hover:bg-slate-300 transition-colors self-start sm:self-auto flex-shrink-0"
      ...
      <div className="flex-grow overflow-y-auto flex flex-col gap-6 sm:gap-8 pr-1 -mr-1">
        {/* Language Controls */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200 shrink-0">
        ...
        {inputText && (
            <div className="border-t border-slate-200 pt-8 animate-fade-in shrink-0 pb-4">
                <div className="mb-6">
