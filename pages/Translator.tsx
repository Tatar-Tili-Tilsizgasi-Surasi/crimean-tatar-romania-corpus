      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex-grow min-h-[200px] p-4 bg-slate-50 border border-slate-200 rounded-lg text-lg text-slate-800 whitespace-pre-wrap overflow-auto">
                     <h3 className="text-xs font-semibold text-slate-500 mb-2 uppercase tracking-wider">Dictionary Lookup (Word-for-word)</h3>
                    {roughResult.translation || <span className="text-slate-400 italic">Translation will appear here...</span>}
                </div>
            </div>
        </div>
      </div>
      ...
      {inputText && (
          <div className="border-t border-slate-200 pt-6 animate-fade-in">
              ...
              <p className="text-sm text-slate-600 mb-4">
                  The following corpus entries contain words from your input text.
              </p>
