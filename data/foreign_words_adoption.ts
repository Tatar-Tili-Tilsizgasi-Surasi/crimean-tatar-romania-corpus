...
milk chocolate → sútlí çokolata "chocolate with (includes) milk"
...
Word end -ğ (English: -ge) becomes -j: George → Ğorj
...
Mihai → Mikayil
David → Dawut
Eugene Sue → Ewjen Súy
Berlioz → Berliyoz
George Sand → Ğorj Sant
de Musset → de Músset
Dumas → Dúmas
Gautier → Gotiye
the Goncourt Brothers → Gonkurt kardaşlarî
Gavarni → Gavarniy
Sainte Beuve → Sent Bóv
Liszt → List
Felix → Feliks
Scheffer → Şeffer
Delacroiz → Delakruwa
Horace Vernet → Horas Vernet
Julius Slowacki → Juliyus Sîlowaskiy
Count Krasinski → Kont Kîrasinskiy
Adam Mickiewicz → Adem Miskiyebiç
`;
