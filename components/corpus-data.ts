...
const posAbbreviations = [
    ...
    'acad\\.', 'adm\\.', 'agr\\.', 'anat\\.', 'antrop\\.', 'aprox\\.', 'arab\\.', 'arh\\.', 'arheol\\.', 'arhit\\.', 'astr\\.', 'auto\\.', 'av\\.', 'biol\\.', 'bis\\.', 'bot\\.', 'card\\.', 'chim\\.', 'cinem\\.', 'col\\.', 'com\\.', 'constr\\.', 'cron\\.', 'd\\.', 'dat\\.', 'dem\\.', 'dim\\.', 'econ\\.', 'electr\\.', 'ent\\.', 'etc\\.', 'expr\\.', 'f\\.', 'fam\\.', 'farm\\.', 'ferov\\.', 'fig\\.', 'filoz\\.', 'fin\\.', 'fitop\\.', 'fiz\\.', 'fiziol\\.', 'folc\\.', 'fon\\.', 'foto\\.', 'gastron\\.', 'geogr\\.', 'geol\\.', 'geom\\.', 'ger\\.', 'gram\\.', 'i\\.', 'iht\\.', 'impers\\.', 'inf\\.', 'inform\\.', 'interog\\.', 'invar\\.', 'ist\\.', 'iz\\.', 'iz\\.prsn\\.', 'jur\\.', 'lat\\.', 'lingv\\.', 'lit\\.', 'log\\.', 'm\\.', 'mat\\.', 'mec\\.', 'med\\.', 'meteo\\.', 'mil\\.', 'minr\\.', 'mitol\\.', 'mong\\.', 'muz\\.', 'n\\.', 'nav\\.', 'neg\\.', 'nehot\\.', 'nom\\.', 'ord\\.', 'orn\\.', 'part\\.', 'peior\\.', 'pers\\.', 'pict\\.', 'pl\\.', 'pol\\.', 'pop\\.', 'pos\\.', 'postp\\.', 'prsn\\.', 'psih\\.', 'pt\\.', 'r\\.', 'radiof\\.', 'recipr\\.', 'redupl\\.', 'reg\\.', 'rel\\.', 'relig\\.', 'sg\\.', 'şcol\\.', 't\\.', 'teatr\\.', 'tehn\\.', 'tel\\.', 'text\\.', 'tipogr\\.', 'topogr\\.', 'transp\\.', 'univ\\.', 'univsl\\.', 'vet\\.', 'vulg\\.', 'zool\\.',
